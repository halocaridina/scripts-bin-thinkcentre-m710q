...
/usr/local/bin/notify-send.sh -i $icon_name --hint=int:transient:1 "Current Brightness: $display_brightness%" --expire-time=3000 --replace-file=/tmp/brightness_notification
