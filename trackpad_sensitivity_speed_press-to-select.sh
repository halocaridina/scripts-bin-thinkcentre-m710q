...
# PATHs when /etc/modprobe.d/psmouse_serio2_setup.conf is commented out
#/usr/bin/echo -n "140" > /sys/devices/rmi4-00/rmi4-00.fn03/serio2/sensitivity
...
/usr/bin/echo -n "180" > /sys/devices/platform/i8042/serio1/serio2/sensitivity
